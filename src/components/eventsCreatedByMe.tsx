...
export default function EventsCreatedByMe(props: any) {
	...
	return (
		<div>
			...
			{events.length === 0 ? (<div className="mx-10"><img className="mt-10 mx-auto" src={`/images/Open Doodles - Petting.png`} alt="" /><p className="mt-10 max-w-2xl text-xl text-gray-500 lg:mx-auto">You haven't created any events. Use the <NavLink to="/events" className="text-primary">Events</NavLink> page to create events and come back here.</p></div>) : (null)}
